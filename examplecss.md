:root {
    ...
    --primary: oklch(0.7704 0.2039 148.4868);
    ...
    --destructive-foreground: oklch(0.1591 0 0);
    --border: oklch(0.3211 0 0);
    --input: oklch(0.2768 0 0);
    --ring: oklch(0.7380 0 0);
    --chart-1: oklch(0.7660 0.1179 145.2950);
    --chart-2: oklch(0.7726 0.1268 231.1149);
    --chart-3: oklch(0.6297 0.1321 299.3578);
    ...
    --sidebar-primary: oklch(0.7704 0.2039 148.4868);
